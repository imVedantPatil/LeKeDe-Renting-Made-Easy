...
public class Product_category_car extends AppCompatActivity
{
    ...
    protected void onStart() {
        ...
        Context c=Product_category_car.this.getApplicationContext();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ArrayAdapter<CharSequence> category_adaptor=ArrayAdapter.createFromResource(this,R.array.sub_category_car,android.R.layout.simple_spinner_item);
        ...
        category.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            {
                Toast.makeText(Product_category_car.this, "Please Select the company", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        postad.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                catch (Exception e)
                {
                    ...
                    Toast.makeText(Product_category_car.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        childref.child(user.getUid()).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(Product_category_car.this, "User Data Successfully Fetched", Toast.LENGTH_SHORT).show();
                }
                catch (Exception e)
                {
                    Toast.makeText(Product_category_car.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            {
                Toast.makeText(Product_category_car.this, "Error!!!!1,Data Unccessfully Fetched"+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getData()
    {
        ...
        if((!checkEmptyCategory(categoryText)) && (!checkEmptyCompany(companyText)) && (!checkEmptyRent(rentText)) && (!checkEmptyDeposit(depositText)) && (descriptionText.isEmpty()) && (!checkEmptyTimespan(timespanText,dayText)))
        {
            ...
            childref.child("Car").child(user.getUid()).setValue(product);
            finish();
            startActivity(new Intent(Product_category_car.this,Addpost_finish.class));
        }
    ...
    private void checkSelected(String selectedText)
    {
        ...
        if(selectedText.equals("Car") || selectedText.equals("MotorBike"))
        {
            ArrayAdapter<CharSequence> mobile_adaptor=ArrayAdapter.createFromResource(this,R.array.company_car_bike,android.R.layout.simple_spinner_item);
            mobile_adaptor.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            company.setAdapter(mobile_adaptor);
        }
        if(selectedText.equals("Bicycles") || selectedText.equals("Industrial"))
        {
            String[] setItem=new String[]{"Nothing To select"};
            ArrayAdapter<String> mo_acc=new ArrayAdapter<String>(this,android.R.layout.simple_spinner_dropdown_item,setItem);
            company.setAdapter(mo_acc);
