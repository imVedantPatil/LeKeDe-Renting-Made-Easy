...
public class Product_category_furniture extends AppCompatActivity {

    private Button postad;
    private Spinner duration;
    private EditText rent,deposit,timespan,description;
    public String rentText,depositText,timespanText,descriptionText,dayText,uri,name,phone_number,email;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_product_furniture);
        ...
        childref.child(user.getUid()).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(Product_category_furniture.this, "User Data Successfully Fetched", Toast.LENGTH_SHORT).show();
                }
                catch (Exception e)
                {
                    Toast.makeText(Product_category_furniture.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            {
                Toast.makeText(Product_category_furniture.this, "Error!!!!1,Data Unccessfully Fetched"+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void getData()
    {
        ...
        if((!checkEmptyRent(rentText)) && (!checkEmptyDeposit(depositText)) && (descriptionText.isEmpty()) && (!checkEmptyTimespan(timespanText,dayText)))
        {
            ...
            childref.child("Furniture").child(user.getUid()).setValue(product);
            finish();
            startActivity(new Intent(Product_category_furniture.this,Addpost_finish.class));

        }
        else if((!checkEmptyRent(rentText)) && (!checkEmptyDeposit(depositText)) && (!descriptionText.isEmpty()) && (!checkEmptyTimespan(timespanText,dayText)))
        {
            String durationText=timespanText.concat(dayText);
